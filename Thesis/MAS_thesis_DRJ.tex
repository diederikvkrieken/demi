...
\usepackage[center]{caption}  % voor caption aanpassingen \usepackage[center]{caption}  % voor centreren caption
...
\mdfdefinestyle{theoremstyle}{%
	linecolor=blue!70!black,linewidth=1pt,%
	frametitlerule=true,%
...
% Title Page
\title{
	{\bf Negotiation of agents in a manufacturing process}\\
	{\it Master Thesis}\\
	{Final Draft\\}
}
