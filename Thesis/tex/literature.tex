...
\citet{endriss2006monotonic} Here some concession protocols are shown, \todo[Todo explain monotonic multilateral concession protocols]{explain the multilateral concession protocols} however, since we are dealing with private information, this is not usefull. 
...
\todo[Explain nash formally here!]{Explaing Nash Formally}
\begin{figure}
	\centering
...
\include{tex/literature.framework}