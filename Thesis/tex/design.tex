...
\todo[Verschillende waarden van W!!]{Verschillende waarden van w toevoegen.}
...
\section{Algorithm}
The algorithm starts with each agent proposing their preferred offer, which is the offer with their highest utility. 

Afterwards, depending on the concession protocol, their desired utility decreases, meaning that the proposal creeps towards the solution space. 

\todo[show example of solution algorithm]{show solution algorithm}
